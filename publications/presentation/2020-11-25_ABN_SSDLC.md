...
# Passwords & Secure Programming<!-- .element style="color: white;" -->
<hr />
...
![](pics/MFA/smartCardReader.jpg)<!-- .element style="box-shadow:none; position: fixed; width: 400px; top: 170px; left: 250px;" -->

<span style="font-size: 26px; position: fixed; left: 20px; bottom: 10px;">Securing users with weak passwords all day</span>
